...
function Radnici() {
  ...
  return (
    <div className="mainRadnici">
      <h1 className="radniciNaslov title-font">Naši radnici</h1>
      ...
      <div className="radnici" id="Radnici">
        ...
        <div className="radnik">
          <img className="profile-pic" src={Radnik7} alt="Kristina Ugrin" />
        ...
        <div className="radnik">
          <img className="profile-pic" src={Radnik8} alt="Marin Zoranić" />
