...
const Obavijest = () => {
  ...
  return (
    <div className={`w-[70%] mt-[50px] relative mb-[100px] ${showPopup ? 'popup-show' : 'popup-hide'}`}>
      <div className="flex flex-col gap-2 bg-pink-300 p-10 border-1 border-pink-300 rounded-lg ">
        <img
          ...
          alt="Donuts"
        />
        <h1 className="text-pink-500 font-extrabold text-3xl title-font">Obavijest!</h1>
